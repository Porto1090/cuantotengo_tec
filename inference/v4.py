...
# from inference.detection.brand_detection import get_brands_from_image, match_brands_to_bottles
...
def run_inference(image, sender_phone=None):
    ...
    # test run time start
    timings["detect_caps"] = time.time() - t0
    # test run time end
    ...
    # test run time start
    timings["detect_front_bottles"] = time.time() - t0
    # test run time end    
